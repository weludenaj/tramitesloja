...
class Switches(ClaseModelo):
    ...
    puertos = models.PositiveIntegerField(verbose_name='Cantidad de Puertos', default=48)
    rack = models.CharField(verbose_name='Ubicacion', max_length=150)
    marca = models.CharField(verbose_name='Marca', max_length=250, null=True, blank=True)
    modelo= models.CharField(verbose_name='Modelo', max_length=150, null=True, blank=True)
    serial=models.CharField(verbose_name='Serial', max_length=50, null=True, blank=True)
    ip= models.CharField(verbose_name='Direccion IP', max_length=15, null=True, blank=True)
    mac=models.CharField(verbose_name='Direccion Mac', max_length=17, null=True, blank=True)
...
class Empleados(ClaseModelo):
    ...
    nombres = models.CharField(verbose_name='Nombre', max_length=350, unique=True)
    correo = models.EmailField(verbose_name='Email', max_length=254, unique=True)
    extension= models.PositiveIntegerField(verbose_name='Extension', blank=True, null=True)
    celular= models.CharField(verbose_name='Celular', max_length=10, blank=True, null=True)
    cargo= models.CharField(verbose_name='Cargo', max_length=250, blank=True, null=True)
    ...
    class Meta:
        ...
        verbose_name_plural = 'Emmpleados'
        ordering = ['nombres',]
...
class Direcciones(ClaseModelo):
    ...
    tipos= models.ForeignKey(TipoDireccion, verbose_name='Tipo', on_delete=models.CASCADE, default=1)
    categoria = models.ForeignKey(Categorias, on_delete=CASCADE, default=1)
    macaddress=models.CharField(verbose_name='Direccion Mac', max_length=17, null=True, blank=True)
    ...
    puerto=models.PositiveSmallIntegerField(verbose_name='Puerto',default=1, null=True, blank=True)
...
class contrasenias(ClaseModelo):
    direccion = models.ForeignKey(Direcciones, verbose_name='Direccion', on_delete=models.CASCADE)
    usuario= models.CharField(verbose_name='usuario', max_length=50, default='admin')
    contrasenia=models.CharField(verbose_name='Contrasena', max_length=50, default='admin')
