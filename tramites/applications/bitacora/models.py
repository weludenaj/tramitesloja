...
class bitacora(models.Model):
    ...
    direccion = models.ForeignKey(direcciones, on_delete=models.CASCADE, default=1)
    tecnico = models.CharField(verbose_name="Asignado", max_length=250, null=True, blank=True)
    ingreso = models.TimeField(verbose_name='Ingresa a', auto_now=False, auto_now_add=False)
    salida = models.TimeField(verbose_name='Sale a', auto_now=False, auto_now_add=False, null=True, blank=True,)
