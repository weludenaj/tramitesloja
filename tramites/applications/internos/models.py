...
class rinternos(models.Model):
    ...
    remite = models.CharField(
        max_length=200, verbose_name="Remitente", null=False, blank=False)
    dependencia = models.CharField(
        max_length=250, verbose_name="Dependencia", default="Externa", null=True)
    #dependencias = models.ManyToManyField(Dependencia)
    descripcion = models.TextField(
        max_length=500, verbose_name="Descripcion", null=False, blank=False)
    nrotramite = models.CharField(
        max_length=30, verbose_name="Tramite Interno", null=True, blank=True)
