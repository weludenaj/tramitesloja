...
class rexternosAdmin(admin.ModelAdmin):
    list_display = ("fechaingreso", "guianro", "usuario", "descripcion",
                    "oficio", "fechaentrega", "enviadoa", "observacion")
    fields = [("fechaingreso", "guianro", "usuario"),
              ("descripcion", "oficio", "fechaentrega"),
              ("enviadoa", "observacion")
              ]
    search_fields = ("fechaingreso", "guianro",
                     "usuario", "oficio", "descripcion")
    # list_filter=("fechaingreso",)
    date_hierarchy = "fechaingreso"


class rinternosAdmin(admin.ModelAdmin):
    list_display = ("secuencia", "fechaingreso", "guianro", "remite",
                    "descripcion", "nrotramite", "fechadespacho", "enviadoa", "observacion")
    fields = [("secuencia", "fechaingreso"),
              ("guianro", "remite"),
              ("descripcion", "nrotramite", "fechadespacho"),
              ("enviadoa", "observacion")
              ]
...
class AdministradorAdmin(admin.ModelAdmin):
    list_display = ("numerocontrato", "administrador", "nombredelcontrato",
                    "contratista", "fechainicio", "fechafinal", "memosend", "memoreceived")
    search_fields = ("administrador", "nombredelcontrato",
                     "contratista", "memosend", "memoreceived")
    ordering = ("-numerocontrato", "administrador",
...
class tramitesdigitalesAdmin(admin.ModelAdmin):
    list_display = ("fechaingreso", "registrado", "identificacion", "correo",
                    "usuario", "tramite", "ceropapeles", "enviadoa", "estado", "observacion")
    search_fields = ("fechaingreso", "registrado",
                     "identificacion", "correo", "usuario", "ceropapeles")
    date_hierarchy = "fechaingreso"
...
class OficioindiceAdmin(admin.ModelAdmin):
    list_display = ("numoficio", "origen", "fecha",  "destinatario",
                    "dpto", "destino", "observacion", "detalle")
    fields = ["numoficio", ("origen", "fecha"),
              ("destinatario", "dpto"),
              ("destino",),
              ("observacion", "detalle")
              ]
...
class SecretariaGAdmin(admin.ModelAdmin):
    list_display = ("fecha", "tramite", "remite",
                    "detalle", "sumilla", "observacion")
...
class MemorandoAlcaldiaAdmin(admin.ModelAdmin):
    list_display = ("nummemorando", "fecha", "dirigidoa",
                    "dependencia", "asunto", "contenido", "observacion")
    fields = [
        ("nummemorando", "fecha"),
        ("dirigidoa", "dependencia"),
        ("asunto",),
        ("contenido", "observacion"),
    ]
    search_fields = ("nummemorando", "dirigidoa",
                     "asunto", "contenido", "observacion")
    date_hierarchy = ("fecha")
    ordering = ("-nummemorando",)


class ordenanzasAdmin(admin.ModelAdmin):
    list_display = ("numero", "ordenanza", "suscrita", "primerdebate",
                    "segundodebate", "sancionada", "observacion", "registro")
    search_fields = ("numero", "ordenanza", "suscrita",
...
class ComunicacionesAdmin(admin.ModelAdmin):
    list_display = ("numero", "fecha", "medios", "entidad",
                    "remite", "asunto", "contestado", "observacion")
...
class planificacionAdmin(admin.ModelAdmin):
    list_display = ("registro", "fecha", "guianro", "categoria", "referencia", "asunto",
                    "remitente", "departamento", "destinatario", "departamentof", "observacion")
    search_fields = ("registro", "fecha", "guianro", "categoria",
                     "referencia", "asunto", "remitente", "destinatario", "observacion")
    fields = [
        ("registro", "fecha", "guianro"),
        ("categoria", "referencia"),
        ("asunto", "remitente",),
        ("departamento", "destinatario", "departamentof"),
        ("observacion"),
    ]
...
class conveniosAdmin(admin.ModelAdmin):
    list_display = ("registro", "institucion", "convenio", "objeto", "plazo", "fechainicio",
                    "fechafinal", "cumplimiento", "encargado", "dependencia", "observacion")
    search_fields = ("registro", "institucion", "convenio", "objeto", "plazo",
                     "fechainicio", "fechafinal", "cumplimiento", "encargado", "observacion")
