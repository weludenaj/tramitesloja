...
class rexternos(models.Model):
    ...
    fechaentrega=models.DateField(null=True, blank=True, verbose_name="Fecha Entrega")
    enviadoa=models.TextField(null=True, blank=True,max_length=350, verbose_name="Enviado a")
...
class Administrador(models.Model):
    numerocontrato = models.CharField(verbose_name="Contrato Nro", max_length=50, null=True, blank=True)
    administrador = models.CharField(verbose_name="Administrador", max_length=250, default="No asignado")
    nombredelcontrato = models.TextField(verbose_name="Nombre del Contrato")
    contratista = models.TextField(verbose_name="Contratista", null=True, blank=True)
    fechainicio = models.DateField(verbose_name="Fecha de Inicio", null=True, blank=True)
    fechafinal  = models.DateField(verbose_name="Fecha de Finalización", null=True, blank=True)
    memosend = models.TextField(verbose_name="Memos Enviados", null=True, blank=True)
    memoreceived= models.TextField(verbose_name="Memos Recibidos", null=True, blank=True)
...
class contraloria(models.Model):
    ...
    fechaingreso=models.DateField(null=False, blank=False, verbose_name="Fecha")
    memorando=models.CharField(max_length=40, verbose_name="Nro Memo/Oficio", null=True, blank=True)
    recomendacion = models.TextField(null=False, blank=False, verbose_name="Recomendación")
    dependencia = models.CharField(max_length=50, verbose_name="Dirigido a ")
    funcionario = models.TextField(null=False, blank=False, verbose_name="Funcionario")
    contestacion=models.TextField(verbose_name="Remitente", null=True, blank=True)
    seguimiento=models.TextField(verbose_name="Seguimiento realizado", null=True, blank=True)
...
class oficiosenviados(models.Model):
  ...
  institucion = models.CharField(verbose_name="Nombre Institución", max_length=500, blank=True, null=True)
  destinatario = models.CharField(verbose_name="Destinatario", max_length=500, blank=True, null=True)
  ...
  fecha = models.DateField(verbose_name= "Fecha Emitido", null=True, blank=True)
...
class tramitesdigitales(models.Model):
    ...
    identificacion = models.CharField(verbose_name="Identificacion", max_length=13, blank=True, null= True)
    ...
    ceropapeles = models.CharField(verbose_name="Cero Papeles", max_length=20, blank=True, null=True)
...
class Oficioindice(models.Model):
    numoficio = models.CharField(verbose_name="Oficio Nro", null=True, blank=True, max_length=10)
    fecha = models.DateField(verbose_name="Fecha", null=True, blank=True, auto_now=False, auto_now_add=False)
    origen = models.ForeignKey(Dependencias, on_delete=models.CASCADE, default=1)
    destinatario  = models.CharField(verbose_name="Destinatario", max_length=450, null=True, blank=True)
    ...
    observacion = models.TextField(verbose_name="Asunto", null=True, blank=True)
    detalle = models.TextField(verbose_name="Observaciones", null=True, blank=True)
    class Meta:
...
class SecretariaG(models.Model):
    fecha  = models.DateField(verbose_name="Fecha", auto_now=False, auto_now_add=False)
    tramite = models.CharField(verbose_name="Tramite/Oficio/Memo", max_length=30, blank=True, null=True)
    remite = models.CharField(verbose_name="Remite", max_length=250)
    detalle = models.TextField(verbose_name="Detalle", default="Ingrese Detalle")
...
class MemorandoAlcaldia(models.Model):
  nummemorando = models.CharField(verbose_name="Memorando", null=True, blank=True, max_length=15)
  fecha = models.DateField(verbose_name="Fecha", null=True, blank=True, auto_now=False, auto_now_add=False)
  dirigidoa = models.CharField(verbose_name="Dirigido A", max_length=250, blank=True, null=True)     
  dependencia = models.ForeignKey(Dependencias, on_delete=models.CASCADE, default=1)
  asunto = models.CharField(verbose_name="Asunto", max_length=150, blank=True, null=True)
...
class ordenanzas(models.Model):
  ...
  suscrita = models.DateField(verbose_name="Suscrita el", auto_now=False, auto_now_add=False)
  primerdebate = models.DateField(verbose_name="Primer Debate", auto_now=False, auto_now_add=False, null=True)
  segundodebate = models.DateField(verbose_name="Segundo Debate", auto_now=False, auto_now_add=False, null=True)
  sancionada = models.DateField(verbose_name="Sancionada", auto_now=False, auto_now_add=False, null=True)
...
class Comunicaciones(models.Model):
  ...
  entidad = models.ForeignKey(EntidadExterna, on_delete=models.CASCADE, default=1)
  remite = models.CharField(verbose_name="Remitente", max_length=350) 
  asunto = models.CharField(verbose_name="Asunto", max_length=350) 
  contestado = models.CharField(verbose_name="Contestado por Oficio Nro", max_length=20)
  observacion = models.TextField(verbose_name="Observacion")
...
class planificacion(models.Model):
    ...
    referencia =models.CharField(max_length=200, verbose_name="Referencia", null=False, blank=False)
    asunto=models.TextField(max_length=500, verbose_name="Asunto", null=False, blank=False)
    remitente=models.CharField(max_length=250, verbose_name="Remitente", null=True, blank=True)
    departamento= models.ForeignKey(Dependencias, on_delete=models.CASCADE, default=1, related_name='Origen')
    destinatario = models.CharField(verbose_name="Destinatario", max_length=250)
    departamentof=models.ForeignKey(Dependencias, on_delete=models.CASCADE, default=1, related_name='Destino')
    observacion=models.TextField(null=True, blank=True, verbose_name="Observacion")
    atendido=models.BooleanField('Atendido', default=False)
...
class convenios(models.Model):
    ...
    fechainicio =models.DateField(null=False, blank=False, verbose_name="Fecha Inicio")
    fechafinal =models.DateField(null=False, blank=False, verbose_name="Fecha Final")
    ...
    encargado =models.CharField(max_length=520, verbose_name="Encargado", null=False, blank=False, unique=False)
    dependencia = models.ForeignKey(Dependencias, on_delete=models.CASCADE, default=1)
    observacion=models.TextField(null=True, blank=True, verbose_name="Observacion")
